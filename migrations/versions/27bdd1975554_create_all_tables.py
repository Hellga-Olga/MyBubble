...
Revision ID: 27bdd1975554
Revises: 
Create Date: 2025-01-06 23:08:52.720562
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('thumbnail_path', sa.String(length=50), nullable=False),
    sa.Column('original_path', sa.String(length=50), nullable=False),
    ...
    with op.batch_alter_table('avatar', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_avatar_timestamp'), ['timestamp'], unique=False)
    ...
    sa.ForeignKeyConstraint(['board_id'], ['board.id'], name='fk_board_id'),
    sa.ForeignKeyConstraint(['parent_post'], ['post.id'], name='fk_parent_post'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('post', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_post_parent_post'), ['parent_post'], unique=False)
    ...
    with op.batch_alter_table('image', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_image_user_id'), ['user_id'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('image', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_image_user_id'))
    ...
    with op.batch_alter_table('post', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_post_parent_post'))
    ...
    with op.batch_alter_table('avatar', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_avatar_timestamp'))
